...
class User:
    ...
    def __str__(self):
        return 'Текущий ползователь {}'.format(self.nickname)
...
# Попытка просмотра видео незарегистрированным пользователем
ur.watch_video('Для чего девушкам парень программист?')
# Регистрация и попытка просмотра видео несовершеннолетним
ur.log_in('pupkin', 'qwerty1')
ur.watch_video('Для чего девушкам парень программист?')
# Просмотр несовершеннолетним разрешенного контента
ur.watch_video('Лучший язык программирования 2024 года')
# Регистрация совершеннолетнего и просмотр видео
